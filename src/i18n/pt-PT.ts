...
export const ptPT: Translations = {
  ...
  video: {
    ...
    videoError: '⚠️ Vídeo não disponível. Coloca o ficheiro na pasta videos/.',
  },
  ...
  confirm: {
    resetHeader: 'Tens a certeza de que queres apagar todo o progresso e recomeçar o quizz?',
    okBtn: 'Sim, recomeçar',
    cancelBtn: 'Cancelar',
  },
};
