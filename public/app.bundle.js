"use strict";(()=>{var p=[{id:1,category:"romanticas",text:"Como percebeste que estavas apaixonado por ela?",videoSrc:"videos/question_01.mp4"},{id:2,category:"romanticas",text:'Qual foi o momento em que pensaste: "\xC9 ela"?',videoSrc:"videos/question_02.mp4"},{id:3,category:"romanticas",text:"O que mais admiras nela?",videoSrc:"videos/question_03.mp4"},{id:4,category:"romanticas",text:"Qual foi o encontro favorito de voc\xEAs?",videoSrc:"videos/question_04.mp4"},{id:5,category:"romanticas",text:"O que ela faz que te deixa sempre feliz?",videoSrc:"videos/question_05.mp4"},{id:6,category:"romanticas",text:"Se pudesses descrev\xEA-la numa palavra, qual seria?",videoSrc:"videos/question_06.mp4"},{id:8,category:"romanticas",text:"O que mais amas na personalidade dela?",videoSrc:"videos/question_08.mp4"},{id:9,category:"romanticas",text:"Como imaginas os dois daqui a 10 anos?",videoSrc:"videos/question_09.mp4"},{id:11,category:"engracadas",text:"Quem pediu quem em namoro \u2014 e como foi?",videoSrc:"videos/question_11.mp4"},{id:12,category:"engracadas",text:"Quem \xE9 mais teimoso?",videoSrc:"videos/question_12.mp4"},{id:13,category:"engracadas",text:"Quem demora mais a arranjar-se?",videoSrc:"videos/question_13.mp4"},{id:14,category:"engracadas",text:"Quem pede desculpa primeiro?",videoSrc:"videos/question_14.mp4"},{id:15,category:"engracadas",text:"Quem \xE9 mais ciumento?",videoSrc:"videos/question_15.mp4"},{id:16,category:"engracadas",text:"Quem gasta mais dinheiro?",videoSrc:"videos/question_16.mp4"},{id:17,category:"engracadas",text:"Quem cozinha melhor?",videoSrc:"videos/question_17.mp4"},{id:18,category:"engracadas",text:"Quem ressona mais? \u{1F602}",videoSrc:"videos/question_18.mp4"},{id:19,category:"engracadas",text:'Qual foi a maior "discuss\xE3o" de voc\xEAs?',videoSrc:"videos/question_19.mp4"},{id:20,category:"engracadas",text:"Quem \xE9 mais dram\xE1tico?",videoSrc:"videos/question_20.mp4"},{id:22,category:"emocionais",text:"Qual foi o momento mais dif\xEDcil que passaram juntos?",videoSrc:"videos/question_22.mp4"},{id:23,category:"emocionais",text:"O que aprendeste com ela?",videoSrc:"videos/question_23.mp4"},{id:25,category:"emocionais",text:"Qual foi o momento mais feliz da rela\xE7\xE3o at\xE9 hoje?",videoSrc:"videos/question_25.mp4"},{id:26,category:"emocionais",text:"O que dirias a ela no altar (resumo)?",videoSrc:"videos/question_26.mp4"},{id:27,category:"emocionais",text:"O que mais admiras na forma como ela cuida das pessoas?",videoSrc:"videos/question_27.mp4"},{id:29,category:"picantes",text:"Quem deu o primeiro beijo?",videoSrc:"videos/question_29.mp4"},{id:30,category:"picantes",text:"Onde foi o primeiro beijo?",videoSrc:"videos/question_30.mp4"},{id:31,category:"picantes",text:"Quem se apaixonou primeiro?",videoSrc:"videos/question_31.mp4"},{id:32,category:"picantes",text:"Quem tomou mais iniciativa no in\xEDcio?",videoSrc:"videos/question_32.mp4"},{id:34,category:"picantes",text:"Quem \xE9 mais carinhoso?",videoSrc:"videos/question_34.mp4"},{id:35,category:"picantes",text:"Quem faz mais surpresas?",videoSrc:"videos/question_35.mp4"}],I=p.length;var h=class{constructor(e){this.gameState=e}getCurrentQuestion(){let e=this.gameState.currentQuestionIndex;return e>=p.length?null:p[e]??null}recordAnswer(e){let t=this.getCurrentQuestion();t&&this.gameState.recordAnswer(t.id,e)}getWinner(){let e=this.gameState.sophieScore,t=this.gameState.teamBrideScore;return e>t?"sophie":"teamBride"}};var E="despedida_sophie_quizz_v1",x=1;function g(){return{version:x,currentQuestionIndex:0,sophieScore:0,teamBrideScore:0,results:[],theme:"light",hasStarted:!1,isFinished:!1}}var f=class{constructor(){this.state=this.load()}load(){try{let e=localStorage.getItem(E);if(!e)return g();let t=JSON.parse(e);return t.version!==x?g():t}catch{return g()}}save(){try{localStorage.setItem(E,JSON.stringify(this.state))}catch{}}reset(){localStorage.removeItem(E),this.state=g()}get currentQuestionIndex(){return this.state.currentQuestionIndex}get sophieScore(){return this.state.sophieScore}get teamBrideScore(){return this.state.teamBrideScore}get results(){return this.state.results}get theme(){return this.state.theme}get hasStarted(){return this.state.hasStarted}get isFinished(){return this.state.isFinished}get totalQuestions(){return p.length}startGame(){this.state.hasStarted=!0,this.save()}recordAnswer(e,t){this.state.results.push({questionId:e,acertou:t}),t?this.state.sophieScore+=1:this.state.teamBrideScore+=1;let o=this.state.currentQuestionIndex+1;o>=p.length?this.state.isFinished=!0:this.state.currentQuestionIndex=o,this.save()}setTheme(e){this.state.theme=e,this.save()}};var k={romanticas:"\u{1F495} Fofas & Rom\xE2nticas",engracadas:"\u{1F602} Engra\xE7adas",emocionais:"\u{1F979} Emocionais",picantes:"\u{1F525} Levemente Picantes"},q={intro:{imgAlt:"Despedida de Solteira da Sophie",titlePre:"Despedida da",titleName:"Sophie",subtitle:"18 de Abril \xB7 O Nardinho responde! \u{1F48D}",description:"A Sophie responde em voz alta \u2014 e depois v\xEA a resposta do Nardinho em v\xEDdeo. Acertou ou errou? O grupo decide!",startAriaLabel:"Iniciar o quizz",startBtn:"Vamos a isso! \u{1F3AC}"},scores:{sophieLabel:"\u{1F485} Sophie",teamBrideLabel:"\u{1F492} Team Bride",questionCounter:(n,e)=>`${n} / ${e}`},question:{categoryLabel:n=>k[n]??n,counter:(n,e)=>`Pergunta ${n} de ${e}`,seeAnswerBtn:"Ver Resposta do Nardinho \u{1F3AC}",seeAnswerAriaLabel:"Ver a resposta do Nardinho em v\xEDdeo"},video:{nowWatching:"\u{1F3AC} Resposta do Nardinho",acertouBtn:"\u2705 Acertou!",errouBtn:"\u274C Errou!",acertouAriaLabel:"A Sophie acertou \u2014 ponto para a Sophie",errouAriaLabel:"A Sophie errou \u2014 ponto para o Team Bride",videoError:"\u26A0\uFE0F V\xEDdeo n\xE3o dispon\xEDvel. Coloca o ficheiro na pasta videos/."},result:{acertouFeedback:"\u2705 Acertou! Ponto para a Sophie!",errouFeedback:"\u274C Errou! Ponto para o Team Bride!",sophiePoint:"+1 para a Sophie \u{1F485}",teamBridePoint:"+1 para o Team Bride \u{1F492}",nextBtn:"Pr\xF3xima Pergunta \u2192",nextAriaLabel:"Avan\xE7ar para a pr\xF3xima pergunta",finishBtn:"Ver Resultado Final \u{1F3C6}",finishAriaLabel:"Ver o resultado final do quizz"},fim:{confettiEmoji:"\u{1F389}",title:"Fim do Quizz!",scoreLabel:"Pontua\xE7\xE3o final",sophieScoreLabel:"\u{1F485} Sophie",teamBrideScoreLabel:"\u{1F492} Team Bride",sophieWinsTitle:"\u{1F451} A Sophie ganhou!",sophieWinsDesc:"A Sophie conhece o Nardinho melhor do que ele pensa! Ela escolhe quantas pessoas quiser do grupo para beber um shot e pagar um mico \xE0 escolha dela. \u{1F485}\u{1F942}",teamBrideWinsTitle:"\u{1F492} O Team Bride ganhou!",teamBrideWinsDesc:"O Team Bride conhece o Nardinho melhor do que a Sophie! A Sophie bebe 3 shots e o grupo escolhe o mico que ela vai pagar. \u{1F608}\u{1F942}\u{1F942}\u{1F942}",tieTitle:"\u{1F91D} Empate!",tieDesc:"Ningu\xE9m ganhou \u2014 ou ganharam os dois! Bebem todos um shot e o mico \xE9 decidido em conjunto pelo grupo. \u{1F942}",resetAriaLabel:"Recome\xE7ar o quizz",resetBtn:"\u21BA Recome\xE7ar"},confirm:{resetHeader:"Tens a certeza de que queres apagar todo o progresso e recome\xE7ar o quizz?",okBtn:"Sim, recome\xE7ar",cancelBtn:"Cancelar"}};var i=q;function v(n){return new Promise(e=>{let t=document.getElementById("confirm-modal"),o=document.getElementById("modal-overlay"),s=document.getElementById("confirm-modal-message"),a=document.getElementById("confirm-ok-btn"),r=document.getElementById("confirm-cancel-btn");if(!t||!o||!s||!a||!r){e(globalThis.confirm(n));return}s.textContent=n;let c=d=>{t.classList.remove("is-open"),o.classList.remove("is-open"),document.body.style.overflow="",a.removeEventListener("click",l),r.removeEventListener("click",m),document.removeEventListener("keydown",u),e(d)},l=()=>c(!0),m=()=>c(!1),u=d=>{d.key==="Escape"&&c(!1),d.key==="Enter"&&c(!0)};a.textContent=i.confirm.okBtn,r.textContent=i.confirm.cancelBtn,a.addEventListener("click",l),r.addEventListener("click",m),document.addEventListener("keydown",u),document.body.style.overflow="hidden",t.classList.add("is-open"),o.classList.add("is-open"),setTimeout(()=>r.focus(),50)})}var b=class{constructor(e="help-btn",t="help-modal",o="modal-overlay"){let s=document.getElementById(e),a=document.getElementById(t),r=document.getElementById(o);if(!s||!a||!r)throw new Error("Help modal elements not found in DOM");this.modal=a,this.overlay=r,s.addEventListener("click",()=>this.open()),r.addEventListener("click",()=>{this.modal.classList.contains("is-open")&&this.close()}),a.querySelector(".modal-close")?.addEventListener("click",()=>this.close()),document.addEventListener("keydown",l=>{l.key==="Escape"&&this.close()})}open(){this.modal.classList.add("is-open"),this.overlay.classList.add("is-open"),document.body.style.overflow="hidden"}close(){this.modal.classList.remove("is-open"),this.overlay.classList.remove("is-open"),document.body.style.overflow=""}};var L=["#6b8f5e","#8fb87e","#c9a96e","#e8c98e","#d4a5b5","#f5c5d0","#a8c8a0","#fde8d0"];function B(n=3e3){let e=document.getElementById("confetti-canvas");if(!e)return;let t=e.getContext("2d");if(!t)return;e.width=window.innerWidth,e.height=window.innerHeight,e.style.display="block";let o=[],s=120;for(let c=0;c<s;c++)o.push({x:Math.random()*e.width,y:-10,vx:(Math.random()-.5)*4,vy:Math.random()*3+2,color:L[Math.floor(Math.random()*L.length)],size:Math.random()*8+4,rotation:Math.random()*360,rotationSpeed:(Math.random()-.5)*6,opacity:1});let a=performance.now();function r(c){if(!t||!e)return;let l=c-a,m=n-800,u=Math.min(l/n,1);t.clearRect(0,0,e.width,e.height);for(let d of o)d.x+=d.vx,d.y+=d.vy,d.rotation+=d.rotationSpeed,d.vy+=.05,l>m&&(d.opacity=Math.max(0,1-(l-m)/800)),t.save(),t.globalAlpha=d.opacity,t.translate(d.x,d.y),t.rotate(d.rotation*Math.PI/180),t.fillStyle=d.color,t.fillRect(-d.size/2,-d.size/2,d.size,d.size*.5),t.restore();u<1?requestAnimationFrame(r):(t.clearRect(0,0,e.width,e.height),e.style.display="none")}requestAnimationFrame(r)}function T(n){n.classList.add("pulse"),n.addEventListener("animationend",()=>n.classList.remove("pulse"),{once:!0})}var S=class{constructor(e,t,o="game-root"){this.phase="question";this.gameState=e,this.engine=t;let s=document.getElementById(o);if(!s)throw new Error(`#${o} not found`);this.root=s}render(){if(!this.gameState.hasStarted){this.renderIntro(),this.renderScoreBar(!1);return}if(this.gameState.isFinished){this.renderFim(),this.renderScoreBar(!1);return}this.renderScoreBar(!0),this.phase==="question"?this.renderQuestion():this.phase==="video"&&this.renderVideo()}renderScoreBar(e,t){let o=document.getElementById("progress-bar");if(!o)return;if(!e){o.innerHTML="";return}let s=this.gameState.sophieScore,a=this.gameState.teamBrideScore,r=(t??this.gameState.currentQuestionIndex)+1,c=this.gameState.totalQuestions;o.innerHTML=`
    ...
    `,this.bindVideoEvents()}bindVideoEvents(){let e=document.getElementById("quiz-video"),t=document.getElementById("video-error-msg"),o=document.getElementById("video-overlay-btn"),s=document.getElementById("video-overlay-icon");if(!e||!t)return;let a=(l,m)=>{!s||!o||(s.textContent=l,o.dataset.state=m)};e.addEventListener("error",()=>{e.hidden=!0,o&&(o.hidden=!0),t.hidden=!1}),e.addEventListener("play",()=>{a("","hidden")}),e.addEventListener("ended",()=>{a("\u21BA","visible"),o&&o.setAttribute("aria-label","Repetir v\xEDdeo")}),o?.addEventListener("click",()=>{e.ended?(e.currentTime=0,e.play().catch(()=>{})):e.paused?e.play().catch(()=>{}):(e.pause(),a("\u23F8","flash"),o&&o.setAttribute("aria-label","Reproduzir v\xEDdeo"),setTimeout(()=>{e.paused&&!e.ended&&a("\u25B6","visible")},600))}),a("\u25B6","visible");let r=document.getElementById("btn-acertou"),c=document.getElementById("btn-errou");r?.addEventListener("click",()=>this.handleAnswer(!0)),c?.addEventListener("click",()=>this.handleAnswer(!1))}handleAnswer(e){let t=document.getElementById("result-actions"),o=document.getElementById("result-feedback"),s=document.getElementById("result-feedback-text"),a=document.getElementById("result-point-text"),r=document.getElementById("btn-acertou"),c=document.getElementById("btn-errou");if(!t||!o||!s||!a)return;r&&(r.disabled=!0),c&&(c.disabled=!0);let l=this.gameState.currentQuestionIndex;this.engine.recordAnswer(e),o.hidden=!1,s.textContent=e?i.result.acertouFeedback:i.result.errouFeedback,s.className=`result-feedback-text ${e?"result-feedback-text--acertou":"result-feedback-text--errou"}`,a.textContent=e?i.result.sophiePoint:i.result.teamBridePoint,this.renderScoreBar(!0,l);let m=document.getElementById("quiz-card");m&&T(m),e&&B(2500),setTimeout(()=>{this.phase="question",this.render()},2500)}renderFim(){let e=this.gameState.sophieScore,t=this.gameState.teamBrideScore,o=this.engine.getWinner(),s=o==="sophie"?i.fim.sophieWinsTitle:i.fim.teamBrideWinsTitle,a=o==="sophie"?i.fim.sophieWinsDesc:i.fim.teamBrideWinsDesc,r=o==="sophie"?"winner-sophie":"winner-bride";this.root.innerHTML=`
    ...
    `,B(6e3),this.bindFimActions()}bindFimActions(){document.getElementById("reset-btn")?.addEventListener("click",()=>{v(i.confirm.resetHeader).then(t=>{t&&(this.gameState.reset(),this.phase="question",this.render())})})}escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}};var y=class{constructor(e,t=["theme-toggle","theme-toggle-mobile"]){if(this.gameState=e,this.toggleBtns=t.map(o=>document.getElementById(o)).filter(o=>o!==null),this.toggleBtns.length===0)throw new Error("No theme toggle buttons found");this.apply(e.theme),this.toggleBtns.forEach(o=>o.addEventListener("click",()=>this.toggle()))}apply(e){document.documentElement.setAttribute("data-theme",e);let t=e==="dark"?"Mudar para modo claro":"Mudar para modo escuro",o=e==="dark"?'<span class="theme-icon">\u2600\uFE0F</span>':'<span class="theme-icon">\u{1F319}</span>';this.toggleBtns.forEach(s=>{s.setAttribute("aria-label",t),s.innerHTML=o})}toggle(){let e=this.gameState.theme==="dark"?"light":"dark";this.gameState.setTheme(e),this.apply(e)}};function w(){let n=new f,e=new h(n),t=new S(n,e);new y(n),new b;let o=document.getElementById("header-menu-toggle"),s=document.getElementById("header-menu-overlay"),a=document.getElementById("header-menu-sidebar"),r=()=>{let u=o?.classList.toggle("is-open");s?.classList.toggle("is-open"),a?.classList.toggle("is-open"),o?.setAttribute("aria-expanded",String(u))};o?.addEventListener("click",r),s?.addEventListener("click",r);let c=document.getElementById("reset-btn-mobile");document.getElementById("help-btn-mobile")?.addEventListener("click",()=>{document.getElementById("help-btn")?.click(),r()}),c?.addEventListener("click",()=>{r(),v(i.confirm.resetHeader).then(u=>{u&&(n.reset(),t.render())})}),document.getElementById("reset-btn-header")?.addEventListener("click",()=>{v(i.confirm.resetHeader).then(u=>{u&&(n.reset(),t.render())})}),t.render()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",w):w();})();
